...
public class Main {
    ...
    private static final String RENT_SCOOTER = "ALUGAR";
    private static final String RELEASE_SCOOTER = "LIBERTAR";
    private static final String SYSTEM_STATE = "ESTADOSISTEMA";
    private static final String CLIENT_WHO_RENTED = "CLIENTE";
    private static final String SCOOTER_RENTED_BY = "TROT";
    ...
    private static final String REACTIVATE_SCOOTER = "REACTROT";
    ...
    /**
     * Applies a promotion to the last rental performed.
     * 
     * @param scanner Reads the user's input.
     * @param system Rental system that is currently being used.
     */
    private static void applyPromotion(Scanner scanner, RentalSystem system) {
        String nif = scanner.next();
        scanner.nextLine();
        if (isNIFEqual(nif, system) && !system.hasClientRented() && !system.isPromotionApplied()) {
            system.promotion();
            System.out.println("Promocao aplicada.");
        } else if (!isNIFEqual(nif, system))
            System.out.println("Cliente inexistente.");
        else if (system.hasClientRented())
            System.out.println("Cliente iniciou novo aluguer.");
        else if (system.isPromotionApplied())
